 ...
 * $page = new SudokuHelperPreferencesPresenter('Options', $headline);
 ...
 */
class SudokuHelperPreferencesPresenter extends PagePresenter
{
    ...
    public function createUninstallationForm(): string
    {
        ...
        return $smarty->fetch('../templates/preferences.uninstall.plugin.sudokuhelper.tpl');
    }
